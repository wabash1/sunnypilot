...
def create_lkas11(packer, frame, car_fingerprint, apply_steer, steer_req,
  ...
  if car_fingerprint in (CAR.SONATA, CAR.PALISADE, CAR.KIA_NIRO_EV, CAR.KIA_NIRO_HEV_2021, CAR.SANTA_FE,
    ...
    values["CF_Lkas_FcwOpt_USM"] = 2 if steer_req else 2 if disengage_blinking_icon else 1 if\
                                   (pause_lateral or below_lane_change_speed) else 1
...
def create_lfahda_mfc(packer, lat_active, pause_lateral, below_lane_change_speed, disengage_blinking_icon, slc_active, speed_limit, speed_limit_changed, switching_to_hda, hda_set_speed=0):
  values = {
    "LFA_Icon_State": 2 if lat_active else 3 if disengage_blinking_icon else 1 if (pause_lateral or below_lane_change_speed) else 0,
